...
class TGAT(nn.Module):
    ...
    def __init__(self, node_raw_features_dim: int, edge_raw_features_dim: int, 
    ...
    def set_feature(self, raw_node_feature, raw_edge_feature):
        # initialize it for every sequence for compatibility
        # although the initial node feature is shared; and we use dummy edge feature for dataset without edge features
        self.node_raw_features = raw_node_feature
        self.edge_raw_features = raw_edge_feature
